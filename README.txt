KPCLI-3.7(1)          User Contributed Perl Documentation         KPCLI-3.7(1)
...
DESCRIPTION
    ...
    database files (http://en.wikipedia.org/wiki/KeePass). It supports all
    version 1.x (*.kdb) and 2.x (*.kdbx) prior to the KDBX4 update.

    This program was inspired by my use of "kedpm -c" combined with my need
...
Version 4 of the KDBX file format is unsupported
    ...
    databases encrypted with AES and newer KeePass versions offer ChaCha20,
    which will also save the file as KDBXv4. You can use the File ->
    Database Settings -> Security tab to change the encryption algorithm to
    AES/Rijndael and, as of KeePass 2.46, kpcli will be able to operate on
    the files.
...
perl v5.26.1                      2022-05-19                      KPCLI-3.7(1)
